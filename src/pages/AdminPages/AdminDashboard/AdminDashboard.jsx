    ...
    <AdminAccountLayout>
      <div className="mx-auto p-[0.5rem] bg-gray-50 min-h-screen">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3 bg-white p-2 rounded-sm shadow">
...
const StatCard = ({ title, value, icon }) => {
  return (
    <div className="p-6 bg-white shadow-least rounded-sm flex items-center gap-5 border-l-4 border-green-500">
